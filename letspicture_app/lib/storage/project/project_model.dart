...
class Project {
  ...
  Size get miniSize {
    ...
    double ratio = Config.miniLongestSide / thumbnailSize.longestSide;
  ...
  Future persist() async {
    if (thumbnailSize == null) throw Error(); // Todo: improve error
    if (isTransient) {
...
class ProjectRepository {
  ...
  static Future<List<Project>> allProjects() async {
    List<Map<String, dynamic>> records = await _db.query(Project.tableName);
