...
import 'package:letspicture_app/editor/adjustments/adjustments_items.dart';
...
class MenuBackdrop extends StatefulWidget {
  ...
  const MenuBackdrop(
      {Key key, this.screenMode, this.updateScreenMode, this.isReady})
      : super(key: key);
...
class _MenuBackdropState extends State<MenuBackdrop>
  ...
  double get opacity {
    if (widget.screenMode == StudioScreenMode.exporting) return 0.0;
...
class _MenuIconsRowState extends State<MenuIconsRow>
  ...
  onPick(AdjustmentsMenuItem option) {
    ...
    return Positioned(
      ...
      child: IgnorePointer(
          ...
          child: AnimatedBuilder(
              animation: this._opacityController,
                ...
                return Material(
                  ...
                  child: Opacity(
                      ...
                      child: Transform.translate(
                          offset: Offset(0, this._animationTranslation.value),
  ...
  Widget _buildOptionsContainer(BuildContext context) {
    return AnimatedContainer(
      ...
      duration: Duration(milliseconds: duration), // todo: constant
      padding: EdgeInsets.only(bottom: 30, top: 30), // todo: constant
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedOpacity(
            ...
            duration: hasPicked
                ...
                : Duration(milliseconds: 100), // todo: constant
