...
import 'package:letspicture_app/editor/exporter.dart';
...
class StudioExportMenu extends StatelessWidget {
  ...
  get showing => screenMode == StudioScreenMode.exporting;

  onExport(ExportConfig config) => () async {
  ...
  Widget build(BuildContext context) {
    final duration = Duration(milliseconds: 550);
