...
import 'package:letspicture_app/view/routes/internal/studio/image/photoview_controller.dart';
...
class _ImageWrapperState extends State<ImageWrapper>
  ...
  TickerFuture animateScale(double to) {
    double from = _photoViewController.scale ?? scaleBoundaries.initialScale;
  ...
  void animateHorizontalPosition(double to) {
    double from = horizontalPosition;
  ...
  void onLayout(ScaleBoundaries boundaries) {
    this.scaleBoundaries = boundaries;
  }

  double get scale {
    if (widget.screenMode == StudioScreenMode.exporting) return 0.85;
