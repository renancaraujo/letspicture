...
import 'package:letspicture_app/view/ui/StreamlineIcon.dart';
...
class _SlideToDeleteState extends State<SlideToDelete>
  ...
  void onHorizontalDragEnd(DragEndDetails details) {
    if (completion >= 0.9) {
      ...
      animateTranslate(0.0, Duration(milliseconds: 500));
    }
  }
  ...
  Widget _buildConfirmation(BuildContext context) {
    double finalHeightFactor =
        heightFactor < 0.2 ? 0.0 : (heightFactor - 0.5) / 0.5;
    double finalOpacityFactor =
    ...
    Matrix4 transform = Matrix4.identity()..scale(scale);
  ...
  Widget _buildDisplay(BuildContext context) {
    Matrix4 transform = Matrix4.identity()..translate(translate);
    ...
    return GestureDetector(
      ...
      child: Align(
          child: Transform(
        transform: transform,
        child: ProjectDisplay(project: widget.project, imageSize: widget.size),
      )),
    );
  }
}
